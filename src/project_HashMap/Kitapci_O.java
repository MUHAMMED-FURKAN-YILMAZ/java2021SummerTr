...
public class Kitapci_O {
    ...
    static HashMap<Integer, List<Kitapci_O>> kitapListe = new HashMap<>();

    public Kitapci_O(String kitapAdi, String yazarAdi, String yayinYili, Integer fiyat) {
    ...
    private static void kitaplariListele() {
        for (Map.Entry<Integer, List<Kitapci_O>> w : kitapListe.entrySet()) {
    ...
    private static void numaraIleKitapSil() {
        ...
        List<Kitapci_O> sonuc = kitapListe.remove(sil);
        if (sonuc == null) {
    ...
    private static void bilgiIleKitapGoruntule() {
        ...
        boolean flag = true;
        for (Map.Entry<Integer, List<Kitapci_O>> w : kitapListe.entrySet()) {
            List<Kitapci_O> kitapBilgi = w.getValue();
            for (Kitapci_O s : kitapBilgi) {
                if (s.kitapAdi.contains((CharSequence) bilgi) || s.yazarAdi.contains((CharSequence) bilgi)) {
    ...
    private static void kitapEkle() {
        ...
        Kitapci_O k = new Kitapci_O(kitapIsim, yazarAdi, yayin, fiyat);
        List<Kitapci_O> kk = new ArrayList<>();
        kk.add(k);
