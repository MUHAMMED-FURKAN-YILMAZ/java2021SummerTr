...
public class C4_IfStatements03 {
	...
	*/	
		...
		char harf= scan.next().toLowerCase().charAt(0);//  next ilk kelimeyi alir, tolowercase harfleri kucultur, charAt ise ilk harfi alir.buyuk kucuk harf girildisinde sorun olmasin diye.
		
		if (harf=='p'|| harf=='P') { // lowercase yapmazsak hepsinde || yaparak kullan�r�z
