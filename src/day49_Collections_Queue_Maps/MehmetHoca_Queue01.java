...
public class MehmetHoca_Queue01 {
    public static void main(String[] args) {
        //queue bir interface'dir dolayhisiyla obje uretemeyiz
        //Child class'i olan PriortyQueue sectigimiz icin Java tarafindan belirlenen
        //priority'e gore siralama yapar

        //priority--> Oncelik demek, biz oncelik olusturmazsak Java kendi onceligini kuruyor
        ...
        //Ancak constructor olarak PriorityQueue sectigimiz icin Java tarafindan belirtlenen
        //priority'e gore siralama yapar
        ...
        k2.remove();// FIFO ilk giren ilk gider
        ...
        k2.remove();// bu satirda son eleman olan Z silindi, artik queue bos
