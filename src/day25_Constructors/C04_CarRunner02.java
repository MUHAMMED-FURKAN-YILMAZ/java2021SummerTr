...
public class C04_CarRunner02 {
	...
	public static void main(String[] args) {
		...
		C01 car1=new C01();// sadece farkli classta ayni isimde obje olusturulur.
	...
	// eger objeyi olustururken deger de atamak istiyorsak
		// Parametereli constructor olusturmamiz gerekir
		...
		System.out.println(car3.fiyat+","+car3.ilanNo+", "+car3.marka+", "+
				car3.model+", "+car3.yil);
	// parametresi olanlara atar olmayanlara default degerler atar
