package project_KelimeTahminOyunu;
...
public class kelimeTahminOyunu_Yol2 {
    /*
    ...
    public static void main(String[] args) {
        ...
        List<String> arrList = Arrays.asList(arr);   //-> Burada array'i bir list'e attim. Cunku ihtiyacim olan fonksiyonlara array sahip degil.
                                                // Ve burada ya da array'de yaptigim degisiklikler birbirini etkiledigi bir problem olusmayacak.
        String tahminKelime = "";
        ...
        List<String> kelimeList = Arrays.asList(arrKelime);  //-> Burada array'i bir list'e attim. Cunku ihtiyacim olan fonksiyonlara array sahip degil.
                                                        // Ve burada ya da array'de yaptigim degisiklikler birbirini etkiledigi bir problem olusmayacak.
