...
public class HashSet01 {
    ...
    /*
 Set : 1) unique(benzersiz tek) elemanlardan olusur, Set'lerin icinde bir eleman sadece bir kere
            kullanilabilir. mükerrer(duplicate) eleman olmaz.
       2) sadece bir null değeri alabilir.(treeSet hariç).Java elementleri unique yapmak icin
          HASH ALGORITMASI kullanir. Java her data icin hashing teknigini kullanarak bir code uretir.
          Bu code'u almak icin HashCode() methodu kullanilir.
          Hashing, farklı büyüklükteki girdilerden sabit büyüklükte bir çıktı oluşturma sürecine
          verilen isimdir. Universitelerdeki ogrenci numaralari gibi bir ogrenci ismi soruldugunda
 ...
 Set-->HashSet: 1)HashSet, duplication’a(tekrarlı eleman) izin vermez.
                ...
                3)HashSet "null" object'ini eleman olarak kullanabilir.
                  Ancak birden fazla null degerini bir HashSet’e eklemek isterseniz sadece bir tane
                    null degeri olur.
 ...
 Set Methods :
     ...
     .containsAll(collection);-->istenen collection’in tumu aranan sette var ise true,
    ...
    public static void main(String[] args) {
        ...
        HashSet<String> hs2=new HashSet<>(List.of("basarili","azimli","nasipli"));// asList yerine bu da olabilir
