...
public class C04_ImmutableClasses02 {
	...
	public static void main(String[] args) {
		...
		String A= "Ali";
		String B= "Ali";
		String C= B+""; // C'nin degeri sonucta yine sadece Ali olsa da Concatenation
						// oldugundan java risk almaz ve yeni referans yeni obje olusturur
		String D= C;
		
		// equals method'u sadece icerige bakar. icerik hepsinde Ali oldugundan
		// equals 2 satirda da true doner
		...
		// kullanilmadan da yeni String olusturabiliriz. String isim="Ali"; gibi
