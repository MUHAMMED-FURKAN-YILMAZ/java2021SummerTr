...
public class C02_PassByValue02 {
	...
	public static void main(String[] args) {
		/*
		 Soru 4 : Bir list ve bir array olusturalim ve 
		 eleman olarak 10,11,12 ekleyelim. Iki method olusturup list
		  ve array’i degistirmeyi deneyelim
		
		-1. Method’da array’e yeni bir array assign edelim 
			ve yeni halini yazdiralim
		
		-2. Method’da list’e yeni bir list assign edelim 
			ve yeni halini yazdiralim
		 ...
		 */
									...
									/* NOOT
		 	JAVA'DA LÝST VEYA ARRAY'IN ELEMANLARINI UPDATE 
		 		ETTINIZDE ELEMANLAR KALICI OLARAK DEGISIR.
		...
		arrayiDegistir(arr);
		System.out.println("arrayy'i degistir method'u calistiktan sonra main method icinde arr :"+
	...
	private static void arrayiDegistir(int[] arr) {
		// bu methodda array'e yeni bir array assign edelim
