package RunnerliClasslar;

import java.util.Scanner;

public class CarRentRunner {
	...
	public static void main(String[] args) {
		...
		;
		System.out.println(
				"Aracinizi şimdiden kiralayin, tatilinizde sinirsiz ozgurluğun ve avantajli kampanyalarin keyfini surun.");
		System.out.println("        _______\r\n" + "       //  ||\\ \\\r\n" + " _____//___||_\\ \\___\r\n"
				+ " )  _          _    \\\r\n" + " |_/ \\________/ \\___|\r\n" + "___\\_/________\\_/______");
		System.out.println(
				"---------------------------------------------------------------------------------------------------------\n\n");
		System.out.println(
				"Java arac kiralama'ya hos geldiniz, lutfen size uyan secenegi giriniz...\n1-Admin girisi\n2-Musteri\n3-Cikis\n");
