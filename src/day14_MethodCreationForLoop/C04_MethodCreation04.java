...
public class C04_MethodCreation04 {
	public static void main(String[] args) {
		 ...
		 * 
		 * Isim ve soyismi ilk harfleri buyuk diger harfler kucuk olacak sekilde, KK
		 * numarasini ise 4 rakamlik 4 blok ve aralarinda bosluk olacak sekilde duzelten
		 * 2 method yazin, ve programda kullanabilmek icin duzenlenmis hallerini geri
		 * dondurun.
		 */
