package OgrenciPractice;
	...
	public class C01_IsimEkleme_HocaninYaptigi {
	    ...
	    private static void menu() {
	        ...
	        while(!cikilsinMi) {
	        System.out.println("L�tfen bir sayi se�iniz\n"
	                + "1-Ekleme\n2-Sileme\n3-G�ncelleme\n4-Listeleme\n5-SiraliListele\n6-Cikis");
	        ...
	        break;
	        case "6":System.out.println("C�kis yapiliyor");
	        cikilsinMi=true;
	        break;
	        default:
	            System.out.println("Uygun bir men� secmediniz");
	            break;
	        }
	        }
	    }
	    ...
	    private static void guncelle() {
	        listele();
	        System.out.println("Yukaridaki listeden g�ncelleme istediginiz elemanin numarasini giriniz");
	        int siraNo=scan.nextInt();//\n
	        scan.nextLine();
	        System.out.println("L�tfen yeni isim giriniz");
